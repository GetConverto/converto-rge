...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Converto — Plus de rendez-vous qualifiés, sans effort" },
      { property: "og:description", content: "Automatisez la qualification et la prise de rendez-vous depuis vos demandes de devis. Conçu pour les PME du bâtiment." },
